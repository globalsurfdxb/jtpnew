...
import MenuSecThree from "./MenuSecThree";
...
const HeroSectionV3 = () => {
  ...
  return (
    ...
    >
        <MenuSecThree/>
      <div className="absolute left-0 top-0 h-screen w-16 bg-white flex flex-col items-center justify-between pt-[80px] xxxl:pt-[100px] pb-[80px] border-r z-20">
      ...
      <div className="prject-sec h-full flex flex-wrap" style={{ width: `${projects.length * 100}vw` }} ref={sectionRef}>
        ...
        {projects.map((project, index) => (
          <div key={project.id} className="slide h-full w-screen relative overflow-hidden text-white">
            ...
            <div className="h-full w-full -z-40 absolute bg-gradient-to-t from-black to-black opacity-60 via-transparent "></div>
            <div
            ...
            <div className="absolute w-full h-full">
              <div className="container h-full">
                <div className="h-full relative">
                  ...
                  >
                    <h2 className="text-xl leading-none">{project.title1} {project.title2}</h2>
                    <div className="grid grid-cols-2 items-start mt-[60px] mb-[50px]">
                      <div>
